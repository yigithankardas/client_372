...
import Panel6 from '../images/panel6.png';

function Profile(props) {
  const {
    ad, soyad, dogumt, yas, boy, kilo, cinsiyet, adres, doktor_mu, hastanead,
  } = props.user;
  ...
  return (doktor_mu
      ...
      <div>
        ...
        <div style={{ display: 'flex', position: 'relative', left: '3cm' }}>
          ...
          >
            ...
            <Paper>
              <img src={Panel6} alt="Panel6" width="300" height="300" />
              <Typography sx={{
                fontSize: '0.8cm',
                display: 'flex',
                justifyContent: 'center',
    ...
    : (
      <div>
        ...
        <div style={{ display: 'flex', position: 'relative', left: '7.2cm' }}>
          <Box
            sx={{
              display: 'flex',
              flexWrap: 'wrap',
